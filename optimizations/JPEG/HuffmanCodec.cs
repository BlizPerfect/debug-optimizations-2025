...
class BitsBuffer
{
    ...
    public void Add(BitsWithLength bitsWithLength)
    {
        ...
        while (bitsWithLength.BitsCount >= neededBits)
        {
            bitsWithLength.BitsCount -= neededBits;
            buffer.Add((byte)((unfinishedBits.Bits << neededBits) + (bitsWithLength.Bits >> bitsWithLength.BitsCount)));

            bitsWithLength.Bits &= (1 << bitsWithLength.BitsCount) - 1;
        ...
        unfinishedBits.BitsCount += bitsWithLength.BitsCount;
        unfinishedBits.Bits = (unfinishedBits.Bits << bitsWithLength.BitsCount) + bitsWithLength.Bits;
    }
